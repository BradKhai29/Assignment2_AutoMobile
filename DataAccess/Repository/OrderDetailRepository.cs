...
namespace DataAccess.Repository
{
    ...
    {
        public AbstractDAO<OrderDetail> DAO { get; set; }
        ...
        public OrderDetail GetByCondition(Func<OrderDetail, bool> condition) => DAO.GetByCondition(condition);

        public OrderDetail GetById(int id) => DAO.GetById(id);

        public DatabaseResponse<OrderDetail> Insert(OrderDetail entity) => DAO.Insert(entity);
